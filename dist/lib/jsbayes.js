        ...
        function defineLib() {
          ...
          jsbayes.newGraph = function () {
            return {
              ...
              samplesAsCsv: function samplesAsCsv(options) {
                var opts = options || {};
              ...
              sample: function sample(samples) {
                var f = function f(g, samples) {
                  if (g.saveSamples) {
              ...
              observe: function observe(name, value) {
              ...
              unobserve: function unobserve(name) {
                var node = this.node(name);
                if (node) {
              ...
              addNode: function addNode(name, values) {
                var node = {
                  name: name,
                  values: values,
                  value: -1,
                  ...
                  valueIndex: function valueIndex(v) {
                  ...
                  initSampleLw: function initSampleLw() {
                    this.sampledLw = undefined;
                  },
                  sampleLw: function sampleLw() {
                    if (this.wasSampled) {
                      return 1;
                    }
                  ...
                  saveSampleLw: function saveSampleLw(f) {
                    if (!this.sampledLw) {
...
//# sourceMappingURL=jsbayes.js.map
